...
const Banner = () => {
  return (
    <>
    <div className='bg-base-300 border-t-2 border-gray-100 text-center'>
      <div className='w-11/12 mx-auto'>
        <h1 className='text-3xl md:text-6xl font-bold mt-10 text-gray-700'>We Build <br />
        ...
        <div className=' my-10 flex flex-wrap items-center justify-center gap-3'>
          ...
          <a href='https://www.apple.com/app-store/' target='_blank' className='btn btn-xl text-lg font-semibold'><img src={AppStoreImg} alt="app store" className='w-8 h-8' /> App Store</a>
        </div>
        <div>
